...
type PromotePgToSingleMaster struct {
...
func (p *PromotePgToSingleMaster) Do(nodeId uuid.UUID) error {
...
func (p *PromotePgToSingleMaster) Undo(uuid.UUID) error {
	return nil
}

func NewPromotePgToSingleMaster(
	nodeRepository components.NodeRepository,
	instanceRepository components.InstanceRepository,
	planRepository components.PlanRepository,
	executor *executor.Executor,
) *PromotePgToSingleMaster {
	return &PromotePgToSingleMaster{
		nodeRepository,
		planRepository,
		instanceRepository,
		executor,
