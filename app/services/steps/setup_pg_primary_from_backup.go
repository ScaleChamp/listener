...
type SetupPgPrimaryFromLatestBackup struct {
...
func (o *SetupPgPrimaryFromLatestBackup) Do(instanceId uuid.UUID, nodeId uuid.UUID) error {
...
func (*SetupPgPrimaryFromLatestBackup) Undo(uuid.UUID, uuid.UUID) error {
	return nil
}

func NewSetupPgPrimaryFromLatestBackup(
	executor *executor.Executor,
	nodeRepository components.NodeRepository,
	instanceRepository components.InstanceRepository,
	encryptionKeyRepository components.EncryptionKeyRepository,
	...
	return &SetupPgPrimaryFromLatestBackup{
		executor,
		nodeRepository,
		instanceRepository,
